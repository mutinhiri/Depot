...
class Product1sControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create product1" do
    assert_difference("Product1.count") do
      post product1s_url, params: { product1: { description: @product1.description, image_url: @product1.image_url, price: @product1.price, title: @product1.title } }
    end
  ...
  test "should update product1" do
    patch product1_url(@product1), params: { product1: { description: @product1.description, image_url: @product1.image_url, price: @product1.price, title: @product1.title } }
